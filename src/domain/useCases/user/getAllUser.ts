...
export class GetAllUsers implements GetAllUsersUseCase {
    ...
    async execute(pageOptionsDto?: PageOptionsDto,searchOptions?: SearchUserDto): Promise<PaginationDto<User>> {
        return await this.userRespository.getUsers(pageOptionsDto,searchOptions);
    }
}